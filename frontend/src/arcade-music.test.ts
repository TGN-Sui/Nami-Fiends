...
describe('arcade-music', () => {
  it('exposes lobby and per-game music slot ids', () => {
    ...
    expect(arcadeGameMusicSlotId('nami-stash-defense')).toBe(
      'arcade-game-music-nami-stash-defense'
    );
    ...
    expect(isArcadeMusicSlotId('arcade-game-music-nami-alley-push')).toBe(true);
