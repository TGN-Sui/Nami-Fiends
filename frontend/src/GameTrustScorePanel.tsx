...
export function GameTrustScorePanel(props: GameTrustScorePanelProps): ReactElement {
  ...
  const breakdown =
    ...
    computeGameTrustScoreFromDraft({
      ...
      steamStoreUrl: props.draft.steamStoreUrl,
      epicStoreUrl: props.draft.epicStoreUrl,
      xboxStoreUrl: props.draft.xboxStoreUrl,
      playstationStoreUrl: props.draft.playstationStoreUrl,
      otherStoreUrl: props.draft.otherStoreUrl,
