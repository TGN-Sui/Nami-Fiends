 ...
 * Usage: node scripts/sync-testnet-env.mjs [--indexer-url URL] [--official-owner 0x...] [--official-owner-email email] [--zklogin-origin URL]
 */
...
VITE_ZKLOGIN_CLIENT_ID=your-google-oauth-client-id.apps.googleusercontent.com
