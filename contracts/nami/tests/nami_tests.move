...
module nami::nami_tests {
    ...
    fun test_black_passport_cannot_create_title_display() {
        ...
        /// ---------------------------------------------------------
    /// Black Passport cannot create a CosmeticLoadout.
    ///
    /// Attack attempt:
    /// - User owns a valid Passport
    /// - User receives valid ConductStatus
    ...
    /// ---------------------------------------------------------
    #[test, expected_failure(abort_code = 101)]
    fun test_black_passport_cannot_create_cosmetic_loadout() {
        let mut scenario = test_scenario::begin(USER);
        ...
        /// ---------------------------------------------------------
    /// Black Passport cannot create a Squad.
    ///
    /// Attack attempt:
    ...
    /// ---------------------------------------------------------
    #[test, expected_failure(abort_code = 31)]
    fun test_black_passport_cannot_create_squad() {
        let mut scenario = test_scenario::begin(USER);
    ...
    fun test_black_passport_cannot_sponsor_squad_member() {
        ...
        /// ---------------------------------------------------------
    /// Black Passport cannot add Guild members.
    ///
    /// Attack attempt:
    /// - User verifies to Adventurer
    ...
    /// ---------------------------------------------------------
    #[test, expected_failure(abort_code = 31)]
    fun test_black_passport_cannot_add_guild_member() {
        let mut scenario = test_scenario::begin(USER);
        ...
        guild::create_guild(
            &passport_obj,
            &status,
            b"black-member-guild",
            b"Guild created before Black Passport",
            true,
            test_scenario::ctx(&mut scenario)
        );
